...
func (s *ChainkitTestSuite) TestNewBigIntFromUint64() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestNewBigIntFromFloat64() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestAmountHumanReadable() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestNewAmountHumanReadableFromStr() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestNewBlockchainAmountStr() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestLegacyGasCalculation() {
	require := s.Require()
