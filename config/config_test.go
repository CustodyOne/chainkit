...
import (
	...
	"github.com/CustodyOne/chainkit/config/constants"
...
func (s *ChainkitTestSuite) TestRequireConfigNotFound() {
	require := s.Require()
	os.Setenv(constants.ConfigEnv, "___not_an_existing_file___")
	cfg := map[string]interface{}{}
	err := RequireConfig("chainkit", &cfg, nil)
	require.Error(err)
	...
	err = RequireConfig("chainkit", &cfg, &cfg)
	require.Error(err)
...
func (s *ChainkitTestSuite) TestRequireConfigParsesYaml() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetSecretEnv() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetSecretFile() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetSecretFileHomeErrFileNotFound() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetSecretErrFileNotFound() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetSecretErrNoColon() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetSecretErrInvalidType() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetSecretVault() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetSecretFileTrimmed() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestUsingDefaults() {
	require := s.Require()
