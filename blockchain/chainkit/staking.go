...
import (
	...
	xcclient "github.com/CustodyOne/chainkit/client"
	"github.com/CustodyOne/chainkit/factory/protocols"
	xc "github.com/CustodyOne/chainkit/types"
)

// Chainkit client assumes that all staking providers might need a post-unstake request-exit.
...
func (client *Client) FetchStakingInput(ctx context.Context, args xcbuilder.StakeArgs) (xc.StakeTxInput, error) {
	...
	return protocols.UnmarshalStakingInput([]byte(r.TxInput))
}
func (client *Client) FetchUnstakingInput(ctx context.Context, args xcbuilder.StakeArgs) (xc.UnstakeTxInput, error) {
	...
	return protocols.UnmarshalUnstakingInput([]byte(r.TxInput))
}
func (client *Client) FetchWithdrawInput(ctx context.Context, args xcbuilder.StakeArgs) (xc.WithdrawTxInput, error) {
	...
	return protocols.UnmarshalWithdrawingInput([]byte(r.TxInput))
}
