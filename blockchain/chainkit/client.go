...
import (
	...
	xclient "github.com/CustodyOne/chainkit/client"
	"github.com/CustodyOne/chainkit/config"
...
// NewClient returns a new Chainkit Client
...
func (client *Client) legacyApiCall(ctx context.Context, path string, data interface{}) ([]byte, error) {
	...
	apiURL := fmt.Sprintf("%s/v1/__chainkit%s", client.URL, path)
...
func (client *Client) FetchTransferInput(ctx context.Context, args *xcbuilder.TransferArgs) (xc.TxInput, error) {
	...
	return protocols.UnmarshalTxInput(r.TxInput)
}
...
// FetchLegacyTxInfo returns tx info from a Chainkit endpoint
...
// FetchNativeBalance fetches account balance from a Chainkit endpoint
...
// FetchBalance fetches token balance from a Chainkit endpoint
