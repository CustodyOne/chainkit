...
// Imported from https://github.com/terra-money/classic-core/blob/main/x/vesting/types/vesting_account.go
// Some code removed for compatibility
...
func (lgva LazyGradedVestingAccount) GetVestedCoins(blockTime time.Time) sdk.Coins {
	...
	// Removed for chainkit compability
