...
Chainkit should work with all cosmos chains, but some of them are not fully backwards compatible
with the latest cosmos-sdk (which chainkit will be on).  To support the incompatible features,
