...
import (
	...
	"github.com/CustodyOne/chainkit/blockchain/cosmos/types"
...
func TestGetSighash(t *testing.T) {
	...
	sighash := tx.GetSighash(&xc.ChainConfig{Protocol: xc.ProtocolCosmos}, []byte{})
	// echo -n '' | openssl dgst -sha256
	require.Exactly(t, "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", hex.EncodeToString(sighash))

	sighash = tx.GetSighash(&xc.ChainConfig{Protocol: xc.ProtocolCosmosEvmos}, []byte{})
