...
func (*StakingInput) GetVariant() xc_types.TxVariantInputType {
	return xc_types.NewStakingInputType(xc_types.ProtocolTron, string(xc_types.Native))
}
...
func (*UnstakingInput) GetVariant() xc_types.TxVariantInputType {
	return xc_types.NewUnstakingInputType(xc_types.ProtocolTron, string(xc_types.Native))
}
...
func (*WithdrawInput) GetVariant() xc_types.TxVariantInputType {
	return xc_types.NewWithdrawingInputType(xc_types.ProtocolTron, string(xc_types.Native))
}
