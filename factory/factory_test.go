...
import (
	...
	"github.com/CustodyOne/chainkit/factory"
...
func TestChainkit(t *testing.T) {
	suite.Run(t, new(ChainkitTestSuite))
}

// NewObject functions

func (s *ChainkitTestSuite) TestNewDefaultFactory() {
	require := s.Require()
	require.NotNil(s.Factory)
}

func (s *ChainkitTestSuite) TestNewTxBuilder() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestNewSigner() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestNewAddressBuilder() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetAddressFromPublicKey() {
	require := s.Require()
	for _, asset := range s.TestChainConfigs {
...
func (s *ChainkitTestSuite) TestGetAllPossibleAddressesFromPublicKey() {
	require := s.Require()
	for _, asset := range s.TestChainConfigs {
...
func (s *ChainkitTestSuite) TestMustAddress() {
	require := s.Require()
	for _, asset := range s.TestChainConfigs {
...
func (s *ChainkitTestSuite) TestGetAssetID() {
	require := s.Require()
	assetID := xc.GetAssetIDFromAsset("USDC", "SOL")
	require.Equal(xc.AssetID("USDC.SOL"), assetID)
}

func (s *ChainkitTestSuite) TestGetAssetConfig() {
	require := s.Require()
...
func (s *ChainkitTestSuite) TestGetAssetConfigEdgeCases() {
	require := s.Require()
...
/*
func (s *ChainkitTestSuite) TestGetTaskConfig() {
	require := s.Require()
...
/*
func (s *ChainkitTestSuite) TestGetTaskConfigEdgeCases() {
	require := s.Require()
...
/*
func (s *ChainkitTestSuite) TestGetMultiAssetConfig() {
	require := s.Require()
...
/*
func (s *ChainkitTestSuite) TestGetMultiAssetConfigEdgeCases() {
	require := s.Require()
	singleAsset, _ := s.Factory.GetAssetConfig("USDC", "SOL")
...
/*
func (s *ChainkitTestSuite) TestGetAssetConfigByContract() {
	require := s.Require()
...
/*
func (s *ChainkitTestSuite) TestPutAssetConfig() {
	require := s.Require()
	assetName := "TEST"
